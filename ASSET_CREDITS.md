...
The active game art is stored in `assets/art`.

## Kenney Pixel Platformer

- Source: https://kenney.nl/assets/pixel-platformer
- License: Creative Commons CC0
- Used for: grass, dirt, ruin stones, trees, bushes, and background tiles.

## Kenney Foliage Pack

- Source: https://opengameart.org/content/foliage-pack-100x
- Author: Kenney
- License: Creative Commons CC0
...
- Author: bevouliin.com
- License: Creative Commons CC0 / OGA-BY 3.0
- Used for: Dark Claw enemy sprite.

## Dark Monster

- Source: https://opengameart.org/content/enemy-game-character-dark-monster
- Author: bevouliin.com
- License: Creative Commons CC0
- Used for: Dark Lake Monster boss sprite.

## Pixel Art Sword Slash Sprites

- Source: https://opengameart.org/content/pixel-art-sword-slash-sprites
- Author: Sanctumpixel
- License: Creative Commons CC0
- Used for: basic sword swing slash artwork.

## Slash Effect

- Source: https://lpc.opengameart.org/content/slash-effect
- Author: MetaShinryu
- License: Creative Commons CC0
- Used for: Silent Nightshade Slice preview artwork.

## Local Effect Placeholders

- Files: `ground-slash.svg`, `nightshade-burst.svg`
- Created for this prototype.
- Used for: Slashing Ground and Silent Nightshade Slice preview artwork.
